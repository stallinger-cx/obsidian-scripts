    ...
    static Instance = class {
        ...
        */
        ...
        renderTable(data, definition, width = "100%") {
            ...
            const headers = definition.map(col => {
                return col.heading ?? col.key ?? ""; // ToDo: small count for first heading!
            });
