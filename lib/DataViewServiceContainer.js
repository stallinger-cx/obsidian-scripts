    ...
    static Instance = class {
        ...
        get formatter() {
            if (!this._instances.formatters) {
                this._instances.formatters = customJS.ViewFormatter;
            }
            return this._instances.formatters;
        }

        /**
         * @returns {ViewRendererInstance}
         */
        get renderer() {
            if (!this._instances.renderer) {
                this._instances.renderer = customJS.ViewRenderer.create(this.dv, this.formatter);
            }
